...
#define serverConfg_h
 ...
 /***************** Thing Speak Settings ************************************/
    ...
    #define milkChillerKey         "1JO243BJO4BUWCHT"        //api Key for Milk Chiller Channel
    #define milkChillerRelayKey    "EZYHDV9EERQB1PNI"        //api Key for Milk Chiller Relay Channel
