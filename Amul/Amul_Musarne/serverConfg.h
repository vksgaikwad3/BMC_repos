...
#define serverConfg_h
 ...
 /***************** Thing Speak Settings ************************************/
    ...
    #define milkChillerKey         "POXBV3P9Y5LH20NF"        //api Key for Milk Chiller Channel
    #define milkChillerRelayKey    "7CJIWSFL97AJHYJ8"        //api Key for Milk Chiller Relay Channel
