...
void sim900_GPRS::SendMessage()
{
  ...
  delay(1000);
  Serial1.println("Device is Power ON in Karanjvhire, Maharashtra");// The SMS text you want to send
  delay(100);
//  Serial1.write(0x1A);
//  Serial1.write(0x0D);
//  Serial1.write(0x0A);
...
void sim900_GPRS::GPRSFailedSMS()
{
  ...
  Serial1.println("AT+CMGS=\"+918983537961\"\r"); // Replace x with mobile number
  delay(1000);
  Serial1.println("GPRS Connection Failed, Retrying to connect, at Karanjvhire, Maharashtra");// The SMS text you want to send
  delay(100);
//  Serial1.write(0x1A);
//  Serial1.write(0x0D);
//  Serial1.write(0x0A);
