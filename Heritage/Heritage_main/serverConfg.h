...
#define serverConfg_h
 ...
 /***************** Thing Speak Settings ************************************/
    ...
    #define milkChillerKey         "HTVKTDDYPRG4Z4UD"        //api Key for Milk Chiller Channel
    #define milkChillerRelayKey    "TLRVDMWVOFNYDV7D"        //api Key for Milk Chiller Relay Channel
