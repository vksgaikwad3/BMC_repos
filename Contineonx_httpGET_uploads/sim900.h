...
class sim900_GPRS
{
  public: 
    ...
    void updateThinkSpeak(String channel_apiKey,float field1,float field2,float field3,float field4,float field5,float field6,float field7,float field8,
                          float field9,float field10,float field11,float field12,float field13,float field14,float field15,float field16); //,float field6,float field7,float field8);
