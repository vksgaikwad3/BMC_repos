...
#define serverConfg_h
 ...
 /***************** Thing Speak Settings ************************************/
    ...
    #define milkChillerKey         "HBRAQTAO06CC0F8A"        //api Key for Milk Chiller Channel
    #define milkChillerRelayKey    "3263X7ZK34GWMX5C"        //api Key for Milk Chiller Relay Channel
